...
const T = {
  ...
  ko: {
    ...
    lede: '추가하면 브라우저를 열지 않아도 아이콘 하나로 오늘의 학습에 바로 들어갑니다. 앱을 삭제하는 방법은 크롬 기준 "chrome://apps/" 로 접속하여 삭제할 수 있습니다.',
    install: '홈 화면에 추가',
    howto: '추가하는 방법 보기',
    openToday: 'TODO Academy 열기',
